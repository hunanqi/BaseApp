...
public final class RegexUtils {
    ...
    public static boolean isTelAll(final CharSequence input) {
        boolean tel = false;
        if (isMatch(RegexConstants.REGEX_TEL, input)||isMatch(RegexConstants.REGEX_MOBILE_EXACT,input)){
            tel=true;
        }
        return tel;
    }
    ...
    public static boolean isIDCard(final CharSequence input) {
        return input.length() == 15 && isMatch(RegexConstants.REGEX_ID_CARD15, input) || input.length() == 18 && isMatch(RegexConstants.REGEX_ID_CARD18, input);
    }
    ...
    public static boolean isTax(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_TAX, input);
    }
