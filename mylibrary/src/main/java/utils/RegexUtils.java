...
public final class RegexUtils {
     ...
     * 验证验证码
     */
    public static boolean isVrifyCode(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_VRIFY_CODE, input);
    }
    ...
    public static boolean isPassWord(final CharSequence input ){
        return isMatch(RegexConstants.REGEX_PASS_WORD, input);
    }
}
